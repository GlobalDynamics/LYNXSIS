	...
	<body>
		...
		<div id="show-usergroup" class="content scaffold-show" role="main">
			...
			<ol class="property-list usergroup">
				...
				<g:if test="${usergroupInstance?.defaultGroup}">
				<li class="fieldcontain">
					<span id="defaultGroup-label" class="property-label"><g:message code="usergroup.defaultGroup.label" default="Default Group" /></span>
					
						<span class="property-value" aria-labelledby="defaultGroup-label"><g:fieldValue bean="${usergroupInstance}" field="defaultGroup"/></span>
